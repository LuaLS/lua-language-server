...
do
    ...
    assert(V4:viewAsList() == '1, 3, 5, 6...(+98)')
end
...
do
    ...
    assert(V1:viewAsList() == '1, 2, 3')
    assert(V2:viewAsList() == '1, 2')
...
do
    ...
    assert(V1:viewAsList() == '1, 2, 3...(+2)')
    assert(V2:viewAsList() == '1, 2...(+3)')
...
do
    ...
    assert(V1:viewAsList() == 'integer?...')

    local V = node.list { node.value(1), V1 }

    assert(V:viewAsList() == '1, integer?...')
end
