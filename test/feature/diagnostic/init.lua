...
test.require 'test.feature.diagnostic.duplicate-doc-alias'
test.require 'test.feature.diagnostic.unknown-cast-variable'
test.require 'test.feature.diagnostic.undefined-doc-name'
test.require 'test.feature.diagnostic.undefined-doc-class'
test.require 'test.feature.diagnostic.doc-field-no-class'
test.require 'test.feature.diagnostic.circle-doc-class'
test.require 'test.feature.diagnostic.duplicate-doc-field'
test.require 'test.feature.diagnostic.incomplete-signature-doc'
test.require 'test.feature.diagnostic.missing-global-doc'
...
test.require 'test.feature.diagnostic.global-element'
...
test.require 'test.feature.diagnostic.debug-staticvalue'
test.require 'test.feature.diagnostic.undefined-global'
test.require 'test.feature.diagnostic.deprecated'
test.require 'test.feature.diagnostic.discard-returns'
test.require 'test.feature.diagnostic.need-check-nil'
test.require 'test.feature.diagnostic.redundant-parameter'
test.require 'test.feature.diagnostic.missing-parameter'
test.require 'test.feature.diagnostic.assign-type-mismatch'
test.require 'test.feature.diagnostic.param-type-mismatch'
test.require 'test.feature.diagnostic.collectgarbage'
test.require 'test.feature.diagnostic.narrow-guard'
test.require 'test.feature.diagnostic.return-type-mismatch'
test.require 'test.feature.diagnostic.missing-return-value'
test.require 'test.feature.diagnostic.redundant-return-value'
test.require 'test.feature.diagnostic.global-in-nil-env'
